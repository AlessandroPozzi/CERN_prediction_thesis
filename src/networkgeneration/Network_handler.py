...
class Network_handler:
    ...
    def draw_network(self, label_choice, location_choice, onlyH0, info_choice, refDevice, hideNames):
        ''' (7) 
        ...
        if self.device_considered=="CUSTOM":
            ...
            imgPath = '../../output/' + self.device_considered + '_' + prior + locat + config.FILE_SUFFIX
