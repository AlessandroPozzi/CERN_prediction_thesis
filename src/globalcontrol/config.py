...
EXTRA = "state" # state, tag, description, livelloPriorita "" : use this to select the extra info to attach to Device (i.e. the "additional field")
...
timestamp = False #True, False. Set to True to use CERN timestamp's.
# In the case of Markov Chains, it calls expandDeviceMarkovTimestamp.py (set mode to "one", use tag as EXTRA, use L0 as selectPriority)
