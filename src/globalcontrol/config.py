...
FILE_SUFFIX = "timestampBefore" #clusters_mc_dbscan, afterNoDup, afterStateNodup, clusters_offline_average1x, clusters_static_distance12sec
...
#              'ESS11/5H', 'ESS406/E91', 'ESS407/E91', 'ESS520/E91',
...
escaped_file_names = ['validation', 'EHS60BE', 'EXS48X', 'EMC0019', 'EXS1062X', 'ESS115H']
...
#                    'ESS406/E91', 'ESS407/E91', 'ESS520/E91', 'ESS11*84']
#                    'ECD1*62']
true_device_names = ['validation', 'EHS60/BE', 'EXS4/8X', 'EMC001*9', 'EXS106/2X', 'ESS11/5H']
