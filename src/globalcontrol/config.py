...
'''markov settings'''
clustering = "offline_average" # no_clustering, mean_shift, db_scan, avg_plus_stdev, offline_average, static_distance
variance = False
timestamp = False

''' expandDevice settings '''
chosenDevices = ['EHS60/BE', 'EXS4/8X', 'EMC001*9', 'EXS106/2X', 'ESS11/5H', 'ESS1*84',
                'ESS406/E91', 'ESS407/E91', 'ESS520/E91'] #, 'ECD1*62']
...
escaped_file_names = ['EHS60BE', 'EXS48X', 'EMC0019', 'EXS1062X', 'ESS115H', 'ESS184',
...
#                    'ESS406/E91', 'ESS407/E91', 'ESS520/E91', 'ESS11*84']
#                    'ECD1*62']
true_device_names = ['EHS60/BE', 'EXS4/8X', 'EMC001*9', 'EXS106/2X', 'ESS11/5H', 'ESS1*84'
